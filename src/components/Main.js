    ...
    const callback = (entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.intersectionRatio >= 0.25) {
          ...
          entry.target.firstElementChild.firstElementChild.classList.add(
            'show'
          );
        } else {
      ...
      <>
        ...
        <div id="container" ref={this.container}>
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[0].mob : list[0].pc)
              })`,
            }}
          >
            <Section01
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[1].mob : list[1].pc)
              })`,
            }}
          >
            <Section01
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[2].mob : list[2].pc)
              })`,
            }}
          >
            <Section01
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[3].mob : list[3].pc)
              })`,
            }}
          >
            <Section01
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[4].mob : list[4].pc)
              })`,
            }}
          >
            <Section01
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[5].mob : list[5].pc)
              })`,
            }}
          >
            <Section01
          ...
          <section
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + (isMobile ? list[6].mob : list[6].pc)
              })`,
            }}
          >
            <Section02 />

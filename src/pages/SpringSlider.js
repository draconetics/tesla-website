      ...
      <div className="spring-slider">
        ...
        >
          <div
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + sliderList[0].img
              }`,
            }}
          ></div>
          <div
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + sliderList[1].img
              }`,
            }}
          ></div>
          <div
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + sliderList[2].img
              }`,
            }}
          ></div>
          <div
            ...
            style={{
              backgroundImage: `url(${
                process.env.PUBLIC_URL + sliderList[3].img
              }`,
            }}
          ></div>
        </Slider>
        <span
          className="spring-slider__right-arrow"
          onClick={() => setSlideCustom('>')}
        >
          <FontAwesomeIcon icon={faGreaterThan} />
        </span>
        <span
          className="spring-slider__left-arrow"
          onClick={() => setSlideCustom('<')}
        >
